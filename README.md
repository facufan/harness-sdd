...
├── package.json           # Deps del arnés (node, Playwright) — NO de tu proyecto
├── specs/<feature>/       # Expediente por feature (Kiro-style)
│   ├── requirements.md    # EARS notation
│   ├── design.md          # Decisiones técnicas + aceptación observable
│   ├── tasks.md           # Checklist de implementación
│   ├── impl.md            # Informe del implementer (mapa R→test + output)
│   ├── acceptance.md      # Veredicto del qa (PASS/FAIL + evidencia)
